...
//   
   ...
   MOTOR1_DUTY_CYCLE((uint16_t)(i2c_buffer[0] *512/100)); 
   MOTOR2_DUTY_CYCLE((uint16_t)(i2c_buffer[1] *512/100)); 
   MOTOR3_DUTY_CYCLE((uint16_t)(i2c_buffer[2] *512/100)); 
   MOTOR4_DUTY_CYCLE((uint16_t)(i2c_buffer[3] *512/100));    
